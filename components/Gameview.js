          ...
          <View class="GameContainer">
              { ((this.props.nbTryGame > 0) && (this.state.rungame === 'before')) &&
                <View class="beforePlaying">
                  <View class='gamename'>{this.props.whichGame.name}</View>
                  <View class='hint'>You have <span class="bigger">30</span> seconds to {this.props.whichGame.rules} <br /><span class="bigger">Ready</span> ?</View>
                  <View class='go' onPress={this.renderGame}>GO</View>
              ...
              { ((this.props.nbTryGame > 0) && (this.state.rungame === 'during')) &&
                <View class="gameBlock">
                  <View class="upQuestionBlock">
                    ...
                    <View class="hint">{this.state.hint === 'x' ? '' : `Hint: ${this.state.hint}`}</View>
              ...
              { this.props.nbTryGame <= 0 &&
                <View>
                  ...
                  <Link to='/home'><Text class='home'>Home</Text></Link>
                </View>
              }
          </View>
      </View>
